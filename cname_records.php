    ...
    <div class="col-md-12">
        <div class="box">
            ...
            <div class="box-footer clearfix">
              <strong>Note:</strong>
              <p>The target of a <code>CNAME</code> must be a domain that the SamAd already has in its cache or is authoritative for. This is a universal limitation of <code>CNAME</code> records.</p>
              <p>The reason for this is that SamAd will not send additional queries upstream when serving <code>CNAME</code> replies. As consequence, if you set a target that isn't already known, the reply to the client may be incomplete. SamAd just returns the information it knows at the time of the query. This results in certain limitations for <code>CNAME</code> targets,
